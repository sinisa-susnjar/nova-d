...
extern (C) {
     ...
     * \ingroup venus
     */
    @safe @nogc double ln_get_venus_sdiam(double JD) pure nothrow;

    /*! \fn double ln_get_venus_rst(double JD, ln_lnlat_posn *observer, ln_rst_time *rst);
     * \brief Calculate the time of rise, set and transit for Venus.
     * \ingroup venus
     */
    @safe @nogc int ln_get_venus_rst(double JD, ln_lnlat_posn *observer,
            ln_rst_time *rst) pure nothrow;

    /*! \fn void ln_get_venus_helio_coords(double JD, ln_helio_posn *position);
     * \brief Calculate Venus heliocentric coordinates
     * \ingroup venus
     */
    /* Chapter 31 Pg 206-207 Equ 31.1 31.2 , 31.3 using VSOP 87 */
    @safe @nogc void ln_get_venus_helio_coords(double JD,
            ln_helio_posn *position) pure nothrow;

    /*! \fn void ln_get_venus_equ_coords(double JD, ln_equ_posn *position);
     * \brief Calculate Venus equatorial coordinates
     * \ingroup venus
     */
    /* Chapter 31 Pg 206-207 Equ 31.1 31.2 , 31.3 using VSOP 87 */
    @safe @nogc void ln_get_venus_equ_coords(double JD,
     ...
     */
    /* Chapter ?? */
    @safe @nogc double ln_get_venus_earth_dist(double JD) pure nothrow;
     ...
     */
    /* Chapter ?? */
    @safe @nogc double ln_get_venus_solar_dist(double JD) pure nothrow;
     ...
     */
    /* Chapter ?? */
    @safe @nogc double ln_get_venus_magnitude(double JD) pure nothrow;
     ...
     */
    /* Chapter 41 */
    @safe @nogc double ln_get_venus_disk(double JD) pure nothrow;
     ...
     */
    /* Chapter 41 */
    @safe @nogc double ln_get_venus_phase(double JD) pure nothrow;

    /*! \fn void ln_get_venus_rect_helio(double JD, ln_rect_posn *position)
     * \ingroup venus
     * \brief Calculate Venus rectangular heliocentric coordinates.
     */
    @safe @nogc void ln_get_venus_rect_helio(double JD,
