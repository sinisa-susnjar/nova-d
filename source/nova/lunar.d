...
import nova.elp.elp1;
import nova.elp.elp2;
import nova.elp.elp3;
import nova.elp.elp4;
import nova.elp.elp5;
import nova.elp.elp6;
import nova.elp.elp7;
import nova.elp.elp8;
import nova.elp.elp9;
import nova.elp.elp10;
import nova.elp.elp11;
import nova.elp.elp12;
import nova.elp.elp13;
import nova.elp.elp14;
import nova.elp.elp15;
import nova.elp.elp16;
import nova.elp.elp17;
import nova.elp.elp18;
import nova.elp.elp19;
import nova.elp.elp20;
import nova.elp.elp21;
import nova.elp.elp22;
import nova.elp.elp23;
import nova.elp.elp24;
import nova.elp.elp25;
import nova.elp.elp26;
import nova.elp.elp27;
import nova.elp.elp28;
import nova.elp.elp29;
import nova.elp.elp30;
import nova.elp.elp31;
import nova.elp.elp32;
import nova.elp.elp33;
import nova.elp.elp34;
import nova.elp.elp35;
import nova.elp.elp36;
...
/* sequence sizes */
enum ELP1_SIZE =	1023;		/* Main problem. Longitude periodic terms (sine) */
enum ELP2_SIZE =	918;		/* Main problem. Latitude (sine) */
enum ELP3_SIZE =	704;		/* Main problem. Distance (cosine) */
enum ELP4_SIZE =	347;		/* Earth figure perturbations. Longitude */
enum ELP5_SIZE =	316;		/* Earth figure perturbations. Latitude */
enum ELP6_SIZE =	237;		/* Earth figure perturbations. Distance */
enum ELP7_SIZE =	14;		/* Earth figure perturbations. Longitude/t */
enum ELP8_SIZE =	11;		/* Earth figure perturbations. Latitude/t */
enum ELP9_SIZE =	8;		/* Earth figure perturbations. Distance/t */
enum ELP10_SIZE =	14328;		/* Planetary perturbations. Table 1 Longitude */
enum ELP11_SIZE =	5233;		/* Planetary perturbations. Table 1 Latitude */
enum ELP12_SIZE =	6631;		/* Planetary perturbations. Table 1 Distance */
enum ELP13_SIZE =	4384;		/* Planetary perturbations. Table 1 Longitude/t */
enum ELP14_SIZE =	833;		/* Planetary perturbations. Table 1 Latitude/t */
enum ELP15_SIZE =	1715;		/* Planetary perturbations. Table 1 Distance/t */
enum ELP16_SIZE =	170;		/* Planetary perturbations. Table 2 Longitude */
enum ELP17_SIZE =	150;		/* Planetary perturbations. Table 2 Latitude */
enum ELP18_SIZE =	114;		/* Planetary perturbations. Table 2 Distance */
enum ELP19_SIZE =	226;		/* Planetary perturbations. Table 2 Longitude/t */
enum ELP20_SIZE =	188;		/* Planetary perturbations. Table 2 Latitude/t */
enum ELP21_SIZE =	169;		/* Planetary perturbations. Table 2 Distance/t */
enum ELP22_SIZE =	3;		/* Tidal effects. Longitude */
enum ELP23_SIZE =	2;		/* Tidal effects. Latitude */
enum ELP24_SIZE =	2;		/* Tidal effects. Distance */
enum ELP25_SIZE =	6;		/* Tidal effects. Longitude/t */
enum ELP26_SIZE =	4;		/* Tidal effects. Latitude/t */
enum ELP27_SIZE =	5;		/* Tidal effects. Distance/t */
enum ELP28_SIZE =	20;		/* Moon figure perturbations. Longitude */
enum ELP29_SIZE =	12;		/* Moon figure perturbations. Latitude */
enum ELP30_SIZE =	14;		/* Moon figure perturbations. Distance */
enum ELP31_SIZE =	11;		/* Relativistic perturbations. Longitude */
enum ELP32_SIZE =	4;		/* Relativistic perturbations. Latitude */
enum ELP33_SIZE =	10;		/* Relativistic perturbations. Distance */
enum ELP34_SIZE =	28;		/* Planetary perturbations - solar eccentricity. Longitude/t2 */
enum ELP35_SIZE =	13;		/* Planetary perturbations - solar eccentricity. Latitude/t2 */
enum ELP36_SIZE =	19;		/* Planetary perturbations - solar eccentricity. Distance/t2 */


/* Chapront theory lunar constants */
enum		RAD =		(648000.0 / PI);
enum		DEG =		(PI / 180.0);
enum		PIS2 =	(PI / 2.0);
enum		ATH =		384747.9806743165;
enum		A0 =		384747.9806448954;
enum		AM =		0.074801329518;
enum		ALPHA =	0.002571881335;
enum		DTASM =	(2.0 * ALPHA / (3.0 * AM));
enum		W12 =		(1732559343.73604 / RAD);
enum		PRECES =	(5029.0966 / RAD);
enum		C1 =		60.0;
enum		C2 =		3600.0;

/* Corrections of the constants for DE200/LE200 */
enum		DELNU =	((0.55604 / RAD) / W12);
enum		DELE =	(0.01789 / RAD);
enum		DELG =	(-0.08066 / RAD);
enum		DELNP =	((-0.06424 / RAD) / W12);
enum		DELEP =	(-0.12879 / RAD);

/*     Precession matrix */
enum		P1 =		0.10180391e-4;
enum		P2 =		0.47020439e-6;
enum		P3 =		-0.5417367e-9;
enum		P4 =		-0.2507948e-11;
enum		P5 =		0.463486e-14;
enum		Q1 =		-0.113469002e-3;
enum		Q2 =		0.12372674e-6;
enum		Q3 =		0.1265417e-8;
enum		Q4 =		-0.1371808e-11;
enum		Q5 =		-0.320334e-14;

/* initialise lunar constants */
void init_lunar_constants ();

/* constants with corrections for DE200 / LE200 */
static const double[5] W1 =
[
